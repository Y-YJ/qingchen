...
<head>
    ...
    <link href="${basePath}/resources/qingchen-admin/plugins/waves-0.7.5/waves.min.css" rel="stylesheet"/>
    <link href="${basePath}/resources/qingchen-admin/plugins/checkbix/css/checkbix.min.css" rel="stylesheet"/>
    <link href="${basePath}/resources/qingchen-admin/css/login.css" rel="stylesheet"/>
</head>
<body>
<div id="login-window">
...
<script src="${basePath}/resources/qingchen-admin/plugins/checkbix/js/checkbix.min.js"></script>
<script>var BASE_PATH = '${basePath}';</script>
<script>var BACK_URL = '${param.backurl}';</script>
<script src="${basePath}/resources/qingchen-admin/js/login.js"></script>
<script>
